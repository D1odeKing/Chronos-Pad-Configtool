...
## 🤖 AI-Generated Codebase Notice

**CRITICAL**: This project's codebase is AI-generated by GitHub Copilot.

### Development Roles
- **AI (GitHub Copilot)**: Writes all code, documentation, and technical implementations
- **Human (David/D1odeKing)**: Provides requirements, feedback, bug detection, testing, and validation

### Code Attribution
All code in this repository should be understood as:
1. **Generated by**: GitHub Copilot AI (GPT-4 based)
2. **Directed by**: David (D1odeKing) - project requirements and specifications
3. **Validated by**: David (D1odeKing) - testing and bug detection
4. **Refined through**: Iterative AI-human collaboration

When contributing or modifying code, maintain this collaboration pattern:
- Human specifies WHAT is needed
- AI implements HOW it works
...
- **AI Attribution**: All documentation should acknowledge AI authorship where appropriate
